class Rational { 
    ...
    public long compareTo(Object x) {
        ...
        simplestForm();
        ((Rational) x).simplestForm();
        if(denominator > ((Rational) x).denominator){
            return -1;
        }
        else if(denominator < ((Rational) x).denominator){
            return 1;
        }
        else{
            if(numerator < ((Rational) x).numerator){
                return -1;
            }
            else if(numerator > ((Rational) x).numerator){
                return 1;
            }
            else{
                return 0;
